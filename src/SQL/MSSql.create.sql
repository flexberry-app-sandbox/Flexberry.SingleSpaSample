...
CREATE TABLE [STORMAuField] (
 ...
 ALTER TABLE [PersonMetaData] ADD CONSTRAINT [PersonMetaData_FPerson_0] FOREIGN KEY ([Author]) REFERENCES [Person]
CREATE INDEX PersonMetaData_IAuthor on [PersonMetaData] ([Author])

 ALTER TABLE [PersonMetaData] ADD CONSTRAINT [PersonMetaData_FPerson_1] FOREIGN KEY ([Person]) REFERENCES [Person]
