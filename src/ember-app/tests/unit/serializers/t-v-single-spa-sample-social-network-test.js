...
moduleForModel('t-v-single-spa-sample-social-network', 'Unit | Serializer | t-v-single-spa-sample-social-network', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:t-v-single-spa-sample-social-network',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
