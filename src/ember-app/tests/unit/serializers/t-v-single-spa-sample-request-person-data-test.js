...
moduleForModel('t-v-single-spa-sample-request-person-data', 'Unit | Serializer | t-v-single-spa-sample-request-person-data', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:t-v-single-spa-sample-request-person-data',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
