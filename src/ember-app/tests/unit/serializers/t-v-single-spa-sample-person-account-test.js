...
moduleForModel('t-v-single-spa-sample-person-account', 'Unit | Serializer | t-v-single-spa-sample-person-account', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:t-v-single-spa-sample-person-account',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
