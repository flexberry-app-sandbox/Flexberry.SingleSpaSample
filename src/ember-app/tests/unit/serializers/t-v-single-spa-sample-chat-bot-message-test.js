...
moduleForModel('t-v-single-spa-sample-chat-bot-message', 'Unit | Serializer | t-v-single-spa-sample-chat-bot-message', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:t-v-single-spa-sample-chat-bot-message',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
